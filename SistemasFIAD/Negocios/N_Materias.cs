    ...
    public class N_Materias
    {
        ...
        public string InsertaMaterias(E_Materias pEntidad)
        {
            ...
            if (R.Contains("Exito"))
                ...
                if (R.Contains("Error"))
                return "Error: Los datos no se insertaron en el sistema. (Clave existente o Nombre de Materia Existente)";
            else
                return R;
        }
        ...
        public List<E_Materias> BuscaMateriaConCriterioEstatus(string CriterioBusqueda, string Estatus)
        {
            return (from Materias in LstMaterias()
                    where
                        Materias.NombreMateria.ToUpper().Contains(CriterioBusqueda.ToUpper()) &&
