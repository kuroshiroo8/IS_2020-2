<%@ Page Title="" Language="C#" MasterPageFile="~/PaginasMaestras/MP_SistemasFIADLogueados.master" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="GePE.WebForm1" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:PropuestaConnectionString %>" SelectCommand="SELECT [IdCarrera], [ClaveCarrera], [NombreCarrera], [AliasCarrera], [EstadoCarrera] FROM [Carreras]"></asp:SqlDataSource>
</asp:Content>
